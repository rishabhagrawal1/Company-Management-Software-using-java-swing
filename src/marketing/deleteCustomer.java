...
// String[] obj=new String[4];
       ...
       tableModel =new MyTableModel(columnNames,data);
        ...
        table.getSelectionModel().addListSelectionListener(new Row3Listener());
 ...
 delete.addActionListener(new java.awt.event.ActionListener() {
    ...
    for (int c : table.getSelectedRows()) {
           ...
           ra=(Row3)data.remove(c); 
           
           String query="delete from cust_dealer_detail where cust_id='"+ra.getCust()+"'";/*+"'&&date='"+ra.getDate()+"'&&quantity='"ra.getQun()+"'&&scrape='"+ra.getScr()+"'";*/
        int rs;
 ...
 private JRadioButton addRadio(String text) {
    ...
    private class Row3Listener implements ListSelectionListener {
    ...
    class MyTableModel extends AbstractTableModel {
        public static final int CUST_INDEX = 0;
     public static final int COM_INDEX = 1;
     public static final int ADD_INDEX = 2;
         public static final int CON_INDEX = 3; 
 ...
 class Row3 {
    ...
    category= "";
     ...
     public void setCust(String customer_id ) {
     ...
     public void setCon(String contact) {
